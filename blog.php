  ...
  <main>
      ...
      <div class="row my-5">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-6 p-5" style="box-shadow: 2px 2px 2px -1px rgba(0, 0, 0, 0.75);"> <br>
          ...
          <div class="d-flex">
            ...
            <div class="text-muted views"><i class="fas fa-eye"></i>&nbsp;
              <?=$row['views']?>&nbsp;&nbsp;&nbsp;
            </div>
    ...
    <div class="container">
      <div class="row my-5">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-6 order-lg-1 p-5"
          style="box-shadow: -2px 2px 2px -1px rgba(0, 0, 0, 0.75);"> <br>
          <div style="font-size: 30px;font-family:Playfair Display SC;color: #252830;font-weight:400;"
            class="text-center title">
            <?php echo $row2["topic"];
            $t=$row2["topic"];
