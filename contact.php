...
<body>
  ...
  <main>
    ...
    <div class="contacts row mx-5">
      <div class="col-md-4">
        <div class="text-center p-4"><a href="tel:+91xxxxxxxxxx"><i class="fas fa-phone fa-2x"></i> &nbsp; +91
            xxxxxxxxxx</a></div>
      </div>
      <div class="col-md-4">
        <div class="p-4 text-center"><i class="fas fa-map-marker-alt fa-2x"></i> &nbsp; University Enclave,New Delhi,
          Delhi 110007</div>
      </div>
      <div class="col-md-4">
        <div class="text-center p-4"><a href="mailto:sk27102002@gmail.com"><i class="fas fa-envelope fa-2x"></i> &nbsp;
            binod@gmail.com</a></div>
      </div>
    </div> <br><br><br><br>
    ...
    <style>
      .form .col-md-6 [type="email"],
      .form .col-md-6 [type="text"],
      .form .col-md-6 [type="tel"] {
        height: 50%;
        display: block;
        width: 100%;
      ...
      .help [type="submit"]:hover,
      .help [type="reset"]:hover {
        background: black;
        color: white;
      ...
      @-webkit-keyframes flicker {
        ...
        100% {
          opacity: 0.99;
          text-shadow: -1px -1px 0 rgba(255, 255, 255, 0.4), 1px -1px 0 rgba(255, 255, 255, 0.4), -1px 1px 0 rgba(255, 255, 255, 0.4), 1px 1px 0 rgba(255, 255, 255, 0.4), 0 -2px 8px, 0 0 2px, 0 0 5px #006eff, 0 0 15px #4744ff, 0 0 2px #3c00ff, 0 2px 3px #000;
        }
    ...
    <div class="help" id="help" style="background:black;">
      ...
      <br><br><br>
      <h3 class="text-white text-center" data-heading="?">How Can We Help <span>?</span></h3> <br>
      ...
      <p class="text-white text-center px-5">If you’ve got a question, a comment or just want to talk more about your
        learning goals <br> leave us a message and we’ll be sure to get in touch.</p>
