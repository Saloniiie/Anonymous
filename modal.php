...
<body>
    ...
    <div class="modal1">
        <div class="popup">
            <div class="d-flex">
                <div class="flex-grow-1"><b>Share Blog Link</b></div>
            ...
            <div class="d-flex">
                ...
                <button onclick="copyurl()" class="btn clipboard"
                    style="background:radial-gradient(circle, rgba(136,189,188,1) 0%, rgba(62,128,146,1) 100%);">Copy
                    URL</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal2">
        <div class="popup">
            ...
            <div class="d-flex">
                <div class="flex-grow-1"></div>
                <button onclick="copyurl2()" class="btn clipboard"
                    style="background:radial-gradient(circle, rgba(136,189,188,1) 0%, rgba(62,128,146,1) 100%);">Copy
                    URL</button>
            </div>
        </div>
